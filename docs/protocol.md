        # Rmst Meta: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/rmst-meta.git

        ## Objective

        RMST Meta v1.1 is a browser-based restricted mean survival time meta-analysis tool with R-validated pooling, targeting Statistical Medicine.
        ...
        - Code: https://github.com/mahmood726-cyber/rmst-meta.git
        - Dashboard: https://mahmood726-cyber.github.io/rmst-meta/
